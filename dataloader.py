...
class Collate():
    ...
    def __call__(self, batch):
        ...
        if self.is_train:
            ...
            # 需要保留每张图片填充之前的尺寸
            return {"images": batch_images, "bboxes": all_bboxes, "labels": all_labels, "fin_img_shape":image_size_before_pad}
        else:
            all_images = [s["images"] for s in batch]
            ...
            return {"images": batch_images, "ori_img_shape":ori_img_shape, "res_img_shape":res_img_shape, "indexs":all_indexs}
